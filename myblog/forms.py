...
class SignUpForm(forms.Form):
    """
    Форма регистрации. 
    Метод clean выполняет проверку поля пароля и его подтверждения, в случае не совпадения вызывает ошибкую
...
class EditProfileForm(forms.Form):
    ...
    Метод clean выполняет проверку пароля и его подтверждения, в случае несовпадения вызывает ошибку.
